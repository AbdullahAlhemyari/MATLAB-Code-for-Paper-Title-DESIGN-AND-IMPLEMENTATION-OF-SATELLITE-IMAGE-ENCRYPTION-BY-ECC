...
p=117;  % choose any prime number to find the x and y in range of -p to p. 
% x and y are the points on ECC curve.
% Find the values of constant a and b that will satisfy the eq 4*a^3+27*b^2~=0  
val_a_b=[];
for a=-10:30
    for b=0:30
...
hold on
%% Multiplication Test
N=69; %Any number to be multiplied with point on EC curve.
