...
close all
clc
p=125;  % choose any value to find the x and y in range of -p to p. 
...
x=eccpoint(:,1);
y=eccpoint(:,2);
plot(x,y,'ro','MarkerFaceColor','b','MarkerSize',10)
% xlim([1 p]);
% ylim([1 p]);
...
R1=ptmulti(P1,N,a);
R2=ptmulti(P2,N,a);
plot(R1(1), R1(2),'bo','MarkerFaceColor','g','MarkerSize',10)
plot(R2(1), R2(2),'bo','MarkerFaceColor','r','MarkerSize',10)
